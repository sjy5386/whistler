...
public class ReplaceDialog extends JDialog {
    ...
    private final JCheckBox wholeWord = new JCheckBox("Match whole word only");
    ...
    public ReplaceDialog(final JFrame owner) {
        ...
        c.gridwidth = 2;
        c.fill = GridBagConstraints.NONE;
        form.add(this.matchCase, c);
        c.gridy = 3;
        form.add(this.wholeWord, c);
    ...
    public void setFindText(final String text) {
        this.findField.setText(Objects.requireNonNullElse(text, ""));
